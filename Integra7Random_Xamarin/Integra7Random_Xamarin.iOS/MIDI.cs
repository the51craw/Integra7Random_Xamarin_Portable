...
namespace Integra7Random_Xamarin.iOS
{
    public class MIDI : IMidi
    {
        ...
        public Integra7Random_Xamarin.iOS.AppDelegate mainPage_iOS;
        ...
        //    if (midiOutPort == null)
        //    {
        //        mainPage_MacOS = DependencyService.Get<Integra7Random_Xamarin_MacOS.AppDelegate>();
        //    }
        //}
        ...
        public MIDI()
        {
            if (midiOutPort == null)
            {
                mainPage_iOS = DependencyService.Get<Integra7Random_Xamarin.iOS.AppDelegate>();
            }
        }
