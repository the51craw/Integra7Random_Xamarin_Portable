...
namespace Integra7Random_Xamarin.UWP
{
    public class MIDI : IMidi, IGenericHandler
    {
        ...
        public void Init(String deviceName, object mainPage_UWP, Picker OutputDeviceSelector, Picker InputDeviceSelector, byte MidiOutPortChannel, byte MidiInPortChannel)
        {
            ...
            //Integra7Random_Xamarin.MainPage.GetMainPage(), 
            //Dispatcher
            //mainPage_UWP.dispatcher;
            //dispatcher = Windows.UI.Core.CoreDispatcher; DependencyObject.Dispatcher; rs
            //Init(deviceName, OutputDeviceSelector, InputDeviceSelector, Integra7Random_Xamarin.MainPage mainPage_UWP.ge, MidiOutPortChannel, MidiInPortChannel);
        }
        ...
        {
            //mainPage_UWP = DependencyService.Get<Integra7Random_Xamarin.UWP.MainPage>();
            this.mainPage = mainPage;
