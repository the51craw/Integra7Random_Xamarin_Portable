...
{
    public class MidiDeviceWatcher: MidiDeviceService
    {
        //DeviceWatcher deviceWatcher;
        string deviceSelectorString;
        Picker deviceComboBox = null;
        MidiReceiver[] midiReceivers;
        ...
        public MidiDeviceWatcher(/*string midiDeviceSelectorString, Picker midiDeviceComboBox, CoreDispatcher dispatcher*/)
        {
            ...
            midiReceivers = GetOutputPortReceivers();
            if (midiReceivers != null)
            {
                INTEGRA_7_Xamarin.UIHandler.btn0.Text = midiReceivers.ToString();
            }
            else
            {
                INTEGRA_7_Xamarin.UIHandler.btn0.Text = "No MIDI devices!";
            }
